...
@Repository //porque hace labores de guardar informacion, con anotacion tenemos que poner el new 
public class DaoPeliculaArray  implements DaoPelicula{
//	private List<Pelicula> listaPelicula = new ArrayList<>(); 
	private List<Pelicula> listaPelicula = new ArrayList<>(); //con la interface da versatilidad asi puedo usar para 
